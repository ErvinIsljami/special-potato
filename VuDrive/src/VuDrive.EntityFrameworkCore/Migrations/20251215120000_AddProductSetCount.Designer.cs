...
namespace VuDrive.Migrations
{
    ...
    [Migration("20251215120000_AddProductSetCount")]
    partial class AddProductSetCount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VuDrive.Cars.Car", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("SpecificationModel")
                        .HasColumnType("TEXT");

                    b.Property<int>("Status")
                        .HasColumnType("INTEGER");

                    b.Property<string>("YearsBuilt")
                        .IsRequired()
                        .HasMaxLength(512)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("VuDrive.Displays.Display", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<decimal>("SizeInInches")
                        .HasColumnType("TEXT");

                    b.HasKey("Id");

                    b.ToTable("AppDisplays", (string)null);
                });

            modelBuilder.Entity("VuDrive.ProductSets.ProductSet", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");

                    b.Property<bool>("BuiltInDisplay")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("VuDrive.ProductSets.ProductSetCar", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("ProductSetId", "CarId")
                        .IsUnique();

                    b.ToTable("AppProductSetCars", (string)null);
                });
            ...
            modelBuilder.Entity("VuDrive.ProductSets.ProductSetCar", b =>
                {
                    b.HasOne("VuDrive.Cars.Car", "Car")
                        .WithMany("ProductSets")
                        .HasForeignKey("CarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VuDrive.ProductSets.ProductSet", "ProductSet")
